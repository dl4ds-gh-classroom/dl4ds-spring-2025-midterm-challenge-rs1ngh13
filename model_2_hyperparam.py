...
def main():
    ...
    step_sizes = [10, 20]                       #list of step sizes to test
    gammas = [0.1, 0.5]                         #list of gamma values to test   
    ...
    for batch, learning, opt, step_size, gamma in product(batch_sizes, learning_rates, optimizers, step_sizes, gammas):                     #loop over all combinations of the parameters
        ...
        if opt == 'SGD':
            optimizer = optim.SGD(model.parameters(), lr=CONFIG['learning_rate'], momentum=0.9)         #test SDG  optimizer
        elif opt == 'ADAM':
