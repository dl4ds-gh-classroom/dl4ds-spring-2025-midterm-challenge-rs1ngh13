...
class ResNet18(nn.Module):
    def __init__(self):
        ...
        self.model = models.resnet18(weights = None)                                                #load ResNet-18 without the pretrained weights
...
def main():
    ...
    CONFIG = {
        "model": "Model_2",   
        "batch_size": 32,               #best batch_size from model_2_hyperparam
        "learning_rate": 0.001,         #best learning_rate from model_2_hyperparam
        "step_size": 10,                #best step_size from model_2_hyperparam
        "gamma": 0.1,                   #best gamma from model_2_hyperparam
        "epochs": 50,                   #increased epochs from model_2_hyperparam to ensure proper training
        "num_workers": 4, 
    ...
    optimizer = optim.Adam(model.parameters(), lr = CONFIG['learning_rate'])                                        #ADAM optimizer -> better than SGD optimizer as tested in model_2_hyperparam
    ...
    submission_df_ood.to_csv("submission_ood_model_2.csv", index=False)
    print("submission_ood_model_2.csv created successfully.")
